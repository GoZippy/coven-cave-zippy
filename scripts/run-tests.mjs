...
export const SUITES = {
  app: [
    ...
    "src/lib/workspace-context.test.ts",
    "src/lib/workspace-context-storage.test.ts",
    ...
    "src/lib/surface-toolbar-actions.test.ts",
    ...
    "scripts/check-test-clock-consistency.test.mjs",
    ...
    "src/lib/research-run-lifecycle.test.ts",
    ...
    "src/components/chat-approve-card.test.tsx",
    "src/components/chat-approve-wiring.test.ts",
    ...
    "src/lib/approve-blocks.test.ts",
    ...
    "src/lib/conversation-revision.test.ts",
    ...
    "src/lib/server/research-resource-embedding-provider.test.ts",
    "src/lib/server/research-resource-extractors.test.ts",
    "src/lib/server/research-resource-fetch.test.ts",
    "src/lib/server/research-resource-ingestion.test.ts",
    "src/lib/server/research-resource-recovery.test.ts",
    "src/lib/server/backup-research-resource-restore.test.ts",
    "src/lib/server/research-resource-lexical-index.test.ts",
    "src/lib/server/research-resource-retrieval.test.ts",
    "src/lib/server/research-resource-semantic-index.test.ts",
    "src/lib/server/research-resource-semantic.test.ts",
    ...
    "src/lib/activity-heatmap-window.test.ts",
    ...
    "src/components/composer-context-pill.test.ts",
    "src/components/composer-enhance.test.ts",
    "src/components/agentic-recommendation-card.test.ts",
    ...
    "src/lib/diagram-command.test.ts",
    ...
    "src/lib/chat-prompt-enhance.test.ts",
    ...
    "src/lib/use-prompt-enhance-behavior.test.ts",
    "src/lib/reply-recommendation.test.ts",
    "src/lib/agentic-diagnostics.test.ts",
    ...
    "src/device-access-proxy.test.ts",
    ...
    "src/app/api/chat/send/inference-route-routing.test.ts",
    ...
    "src/lib/enrich-steps-orchestration.test.ts",
    "src/lib/board-agentic-enhance.test.ts",
  ...
  api: [
    ...
    "src/lib/delivery-evidence-contract.test.ts",
  ...
  // unit-6/7 search tests import the coordinator/query/parser via "@/lib/…".
    ...
    "src/lib/canvas-git-delivery.test.ts",
    "src/lib/server/canvas-project-file-guard.test.ts",
    "src/app/api/canvas/github-source/route.test.ts",
    ...
    "src/lib/server/bundled-copilot-plugins.test.ts",
